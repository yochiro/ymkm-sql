...
/**
 * Defines statement for FROM part of an SQL query
 *
 ...
 * @package ymkm-sql
 */
final class YMKM_SQL_Statement_From extends YMKM_SQL_Statement_Base
{
    /**
    ...
    {
        // Returns FROM (entity->parse), ...
        return 'FROM ' . $entitiesFn(
